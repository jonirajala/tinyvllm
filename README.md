...
### Quick Summary (TinyLlama 1.1B on Apple M4)

| Metric | Value |
|--------|-------|
| Decode throughput | 1.9 tok/s |
| TPOT (Time Per Output Token) | 520 ms |
| Concurrent speedup (5 req) | 2.2x |
| Utilization vs theoretical | ~5% |
...
See [docs/PROFILING.md](docs/PROFILING.md) for detailed profiling analysis.

**Key finding:** The 50x gap between achieved (1.9 tok/s) and theoretical (55 tok/s) is due to framework overhead (Python scheduling, data copies), not GPU kernel speed. See Phase 7.9 in phases.md for optimization roadmap.
